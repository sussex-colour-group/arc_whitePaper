...
for aboveBelow = [0,1]
    ...
    [~,xneg] = compute95pctCI(data_PP(1,data_PP(5,:) == 0 & data_PP(7,:) == aboveBelow));
    xpos = xneg;
    [~,yneg] = compute95pctCI(data_PP(2,data_PP(5,:) == 0 & data_PP(7,:) == aboveBelow));
    ypos = yneg;

    errorbar(mean(data_PP(1,data_PP(5,:) == 0 & data_PP(7,:) == aboveBelow),"omitnan"),...
        mean(data_PP(2,data_PP(5,:) == 0 & data_PP(7,:) == aboveBelow),"omitnan"),...
        yneg,ypos,xneg,xpos,...
...
clear labelH
for aboveBelow = [0,1]
        labelH{aboveBelow+1} = text(mean(data_PP(1,data_PP(5,:) == 0 & data_PP(7,:) == aboveBelow),"omitnan"),...
            mean(data_PP(2,data_PP(5,:) == 0 & data_PP(7,:) == aboveBelow),"omitnan"),...
